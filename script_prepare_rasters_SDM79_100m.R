...
r.road=raster("env_variables/dens_roads.asc")
r.forest.edge=raster("env_variables/dens_forest_edges.asc")
r.hedge=raster("env_variables/dens_hedges.asc")
r.river=raster("env_variables/dens_river.asc")
...
summary(env.var)
write.table(env.var,file="env_variables_100m.txt", sep="\t", row.names=F) #save the table in the working directory
...
write.table(sum.env.var,file="summary_env_variables_100m.txt", sep="\t", row.names=F) #save the table in the working directory


#Now read the table and do some graphics
env.var=read.table("env_variables_100m.txt", h=T) #read the table
summary(env.var)
